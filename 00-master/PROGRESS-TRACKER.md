...
- ✅ GitHub Pages 활성화 + 도메인 — `https://jonathanblackdoctor.github.io/Cuyeonsi-beta/` 라이브 (2026-05-11, HTTP 200 OK + og:title/twitter card 정상)
- ✅ **베타 출시 🎉** (`Cuyeonsi-beta` Pages, 2026-05-11) — 친구 피드백 수집 라운드 진행 중. CI e2e timeout 옵션 C(15→30분) 처방으로 그린 복구.
